  ...
  render(){
    ...
    <div className="container ">
      ...
      <div className="form-group">
        ...
        <div className="form-group">
          <input type="text" className="form-control" name ="fullname"  placeholder="Dealer name" onChange={this.onChangeHandler} value={_this.state.dealer.fullname}/>
        </div>
        <div className="form-group">
          <input type="email" className="form-control" name="email" placeholder="Dealer E-mail" onChange={this.onChangeHandler} value={_this.state.dealer.email}></input>
        </div>
        <div className="form-group">
          <input type="tel"className="form-control" name="mobile" placeholder="Dealer Mobile" onChange={this.onChangeHandler} value={_this.state.dealer.mobile}></input>
        </div>
        <div className="form-group">
          <input type="email" className="form-control" name="email1" placeholder="Alternate Email, if any" onChange={this.onChangeHandler} value={_this.state.dealer.email1}></input>
         </div>
        <div className="form-group">
          <input type="tel"className="form-control" name="mobile1" placeholder="Alternate Mobile, if any" onChange={this.onChangeHandler} value={_this.state.dealer.mobile1}></input>
        </div>
        <div className="form-group">
          <textarea type="text" className="form-control" name="address" placeholder="Dealer Address" onChange={this.onChangeHandler} value={this.state.dealer.address} ></textarea>
        </div>
        <div className="form-check">
            <input type="checkbox" className="form-check-input" id="checkbox" onChange={this.onChangeHandler}  value={_this.state.dealer.isservicecenter}></input>
